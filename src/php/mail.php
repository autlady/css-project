...
/* $project_name = trim($_POST["Центр Сопровождения Сайтов"]);
$admin_email  = trim($_POST["myemail@mail.ru"]);
$email_from  = trim($_POST["info@portfolio.ru"]); */
// $form_subject = trim($_POST["form_subject"]);
$project_name = "juliapge.beget.tech";
$admin_email = "julia_panina@mail.ru, littlesteps_spb@mail.ru";
$email_from = "info@juliapge.beget.tech";
$message="";
...
$form_subject = 'Заявка с сайта Центр Сопровождения Сайтов';
